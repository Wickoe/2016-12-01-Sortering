...
public class Opgave2Tester {
    public static void main(String[] args) {
        ...
        String[] sortedStringArray =
            StringCustomerSelectionSort.selectionSort(unsortedStringArray);
        ...
        for (Customer c : StringCustomerSelectionSort.selectionSort(customers)) {
            System.out.println(c);
        }
    }
