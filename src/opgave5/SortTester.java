...
public class SortTester {
	...
	public static void main(String[] args) {
		...
		System.out.println(String.format("BubbleSort (%d) -- Total time in seconds: %d", testSize,
				Measurer.durationMilliSeconds() / 1000));
		...
		System.out.println(String.format("InsertionSort (%d) -- Total time in milliseconds: %d", testSize,
				Measurer.durationMilliSeconds()));
		System.out.println(String.format("InsertionSort (%d) -- Total time in seconds: %d", testSize,
				Measurer.durationMilliSeconds() / 1000));
		...
		System.out.println(String.format("SelectionSort (%d) -- Total time in milliseconds: %d", testSize,
				Measurer.durationMilliSeconds()));
		System.out.println(String.format("SelectionSort (%d) -- Total time in seconds: %d", testSize,
				Measurer.durationMilliSeconds() / 1000));
	}
